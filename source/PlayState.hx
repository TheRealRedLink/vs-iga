			...
			case 'igastage':
				{
						defaultCamZoom = 0.9;
						curStage = 'igastage';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('igastageback'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
	
						var stageFront:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('igastagefront'));
